...
const speed = "speed"
const smart = "smart"
var pins = ["4166454-27251362", "xxhy1990", "jd_42e72a4a4801d", "uihcc", "forgetqueque", "汤家小妹", "jd_7786d354c65f9"];
let cookiesArr = [];
var helps = [];
var tools = [];
var maxTimes = 3;
...
!(async () => {
     ...
     for (let i in cookiesArr) {
          ...
          var address = pins.indexOf(decodeURIComponent(cookie.match(/pt_pin=([^; ]+)(?=;?)/) && cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1]))
          if (!$.isNode() || address != -1) {
