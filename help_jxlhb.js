...
$.self = ["4166454-27251362", "xxhy1990", "jd_42e72a4a4801d", "uihcc"];
if ($.isNode()) {
...
!(async () => {
  ...
  await $.wait(60000-nowSeconds.getSeconds()*1000-nowSeconds.getMilliseconds()+5);
      ...
      try {
        if (err) {
          ...
          if (data.iRet === 0) {
            ...
            if (data.sErrMsg === '未达到抽奖资格') $.canOpen = false
          }
        }
      } catch (e) {
        $.logErr(e, resp);
