...
let cookiesArr = [], cookie = '', jdFruitShareArr = [], isBox = false, notify = $.isNode() ? require('./sendNotify') : '', newShareCodes, allMessage = '';
//助力好友分享码(最多3个,否则后面的助力失败),原因:京东农场每人每天只有3次助力机会
//此此内容是IOS用户下载脚本到本地使用，填写互助码的地方，同一京东账号的好友互助码请使用@符号隔开。
//下面给出两个账号的填写示例（iOS只支持2个京东账号）
let shareCodes = [
  '40b8243fd141427988673c0715e916af',
  'b1fb8c3e764449ffb2377954c57cf4fb',
  '452fffb11d6348eaa69173eb8d913eee',
  '56c340fd72844006882ea673741da3c6',
  'ce05c0096231465c9799578b9a8f749a',
  '8cfb5315dec44be09fd06e963f141dee',
  'bee0dd1ea1f94c0eb55e805b44a189a6'
];
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      await jdFruit();
      if ($.fullHelp.length === newShareCodes.length) {
        console.log('助力已满，停止助力');
        break;
      }
    }
  }
...
async function masterHelpShare() {
  ...
  for (let code of newShareCodes) {
    if ($.fullHelp.indexOf(code) !== -1) continue;
